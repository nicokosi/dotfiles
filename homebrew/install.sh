...
# development:
brew install git Caskroom/cask/java Caskroom/cask/java7 jenv maven tig Caskroom/cask/intellij-idea-ce Caskroom/cask/sbt Caskroom/cask/lighttable leiningen
