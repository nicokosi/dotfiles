...
# development:
brew install git Caskroom/cask/java Caskroom/versions/java6 Caskroom/versions/java7 jenv maven tig Caskroom/versions/intellij-idea-ce sbt Caskroom/cask/lighttable leiningen typesafe-activator
